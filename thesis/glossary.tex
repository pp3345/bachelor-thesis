...
\newacronym[description={A unit in a processor that monitors load and power consumption of different components within the chip and dynamically assigns frequencies and voltages as needed}]{PCU}{PCU}{Power Control Unit}
\newacronym[description={A generic term for techniques that seek to maximize both energy efficiency and performance by dynamically selecting frequencies along with appropriate voltages for different components of a microprocessor}]{DVFS}{DVFS}{Dynamic Voltage and Frequency Scaling}\glsunset{DVFS}
