...
\newacronym[description={The main execution unit of a computer}]{CPU}{CPU}{Central Processing Unit}\glsunset{CPU}
...
\newacronym[description={A specific processor product brought to market}]{SKU}{SKU}{Stock-Keeping Unit}\glsunset{SKU}
\newacronym[description={A set of early \gls{vectorinst} sets for the x86 architecture, which are still commonly supported by modern \glspl{CPU} but do not require frequency reduction for stable execution}]{SSE}{SSE}{Streaming \gls{SIMD} Extensions}\glsunset{SSE}
