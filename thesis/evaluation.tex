...
\begin{figure*}
	...
	\end{tikzpicture}
	\caption{Exemplary run of our multi-phase execution tool when called with \texttt{200~150~400~0~100} as command line. \SI{512}{\bit} \gls{AVX} is executed for a duration of \SI{200}{\micro\second}, then \SI{256}{\bit} \gls{AVX} for \SI{150}{\micro\second}, then purely scalar instructions for \SI{400}{\micro\second}, and finally a last phase with \SI{256}{\bit} \gls{AVX} for another \SI{100}{\micro\second}.}
