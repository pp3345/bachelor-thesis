...
As shown, these modifications allow us to fully employ our analysis framework with all its features without drawbacks in combination with \textsc{avxfreq} enabled.
