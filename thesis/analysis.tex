...
\begin{figure*}
	...
	\begin{subfigure}[b]{0.6\textwidth}
		...
		% legend
		\draw[fill=kitgreen, color=kitgreen] (-2.5, 1.5) rectangle ++(\legendbarlength cm, \levelheight cm);
		\node[minimum height=\levelheight cm, text centered, anchor=west] at (-2.15, 1.6) {AVX};
