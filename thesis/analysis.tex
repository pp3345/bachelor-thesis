...
\begin{itemize}
	...
	\item Level~2: \gls{AVX-512} floating-point, integer multiplication  or integer \gls{FMA} instructions are being executed. The maximum frequency is lowered to a \gls{SKU}-specific value that is further below the frequency used in level~1.
\end{itemize}
