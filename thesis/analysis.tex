...
\begin{figure*}
	...
	\begin{subfigure}[b]{0.6\textwidth}
		...
		\draw[decorate, decoration={brace, amplitude=3pt, mirror}] (0.7, 0.3) -- ++(0.6 cm,0) node[pos=0.5, anchor=north, yshift=-0.1cm, align=center] {measure \\ instructions};
		\end{tikzpicture}
		\caption{Level~1}
	\end{subfigure}%
	\begin{subfigure}[b]{0.4\textwidth}
		...
		\pgfmathsetmacro{\linetwoy}{\lineoney-\linedistance}
		\pgfmathsetmacro{\interbararrowheight}{\linedistance-\barheight}
		\pgfmathsetmacro{\measurey}{\linetwoy}
