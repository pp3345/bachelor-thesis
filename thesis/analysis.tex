...
\begin{figure}
	...
	\end{axis}
	\end{tikzpicture}
	\caption{Required \SI[number-unit-product=-]{256}{\bit} \texttt{vfmaddsub132pd} instructions to trigger a turbo license switch to level~1. Unlike with \SI{512}{\bit} instructions, the amount varies a lot.}
